...
public class DionisView extends ViewPart {
	...
	private void createCommonSettingsTabs() {
		...
		spinner_8.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, true,
				false, 1, 1));
		...
		spinner_9.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, true,
				false, 1, 1));
		...
		table_3 = new Table(composite_11, SWT.BORDER | SWT.FULL_SELECTION);
		...
		final MenuItem menuItem3_1 = new MenuItem(menu_3, SWT.NONE);
		menuItem3_1.setText("Изменить");
		final MenuItem menuItem3_2 = new MenuItem(menu_3, SWT.NONE);
		menuItem3_2.setText("Добавить");
		final MenuItem menuItem3_3 = new MenuItem(menu_3, SWT.NONE);
		menuItem3_3.setText("Удалить");
		...
		menu_3.addListener(SWT.Show, new Listener() {
			...
			public void handleEvent(Event event) {
				...
				if (selected.length == 0) {
					menuItem3_1.setEnabled(false);
					menuItem3_2.setEnabled(true);
					menuItem3_3.setEnabled(false);
				} else {
					menuItem3_1.setEnabled(true);
					menuItem3_2.setEnabled(true);
					menuItem3_3.setEnabled(true);
				}
			}
		});
		...
		menuItem3_2.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				AddressTableDialog dialog = new AddressTableDialog(shell);
				dialog.open();
			}
		});
		menuItem3_3.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {

			}
		});

		TableColumn tblclmnNewColumn_4 = new TableColumn(table_3, SWT.NONE);
		tblclmnNewColumn_4.setWidth(100);
		tblclmnNewColumn_4.setText("Адрес");

		TableColumn tblclmnNewColumn_3 = new TableColumn(table_3, SWT.NONE);
		tblclmnNewColumn_3.setWidth(100);
		tblclmnNewColumn_3.setText("Имя");
	...
	private void createNetSettingsTabs() {
		...
		Table table_4 = new Table(composite_4, SWT.BORDER | SWT.FULL_SELECTION);
		...
		Tree tree = new Tree(composite_5, SWT.BORDER);
		...
		Table table_5 = new Table(composite_6, SWT.BORDER | SWT.FULL_SELECTION);
